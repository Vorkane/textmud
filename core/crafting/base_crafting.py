...
class CraftingRecipe(CraftingRecipeBase):
    ...
    def pre_craft(self, **kwargs):
        ...
        tool_map = {
            ...
            if obj and hasattr(obj, "tags") and inherits_from(obj, "evennia.objects.models.ObjectDB")
        }
        ...
        consumable_map = {
            ...
            for obj in self.inputs
            if obj and hasattr(obj, "tags") and obj not in tool_map and inherits_from(obj, "evennia.objects.models.ObjectDB")
        }
